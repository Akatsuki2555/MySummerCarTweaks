...
namespace MySummerCarTweaks.Tweaks.BetterFPSMeter
{
    internal class BetterFPSMeterModule : MscTweak
    {
        ...
        private SettingsSlider _fpsMultiplier;
        ...
        {
            _fpsMultiplier = Settings.AddSlider(mod, "fpsMultiplier", "FPS Multiplier", 1f, 3f, 1f);
        ...
        internal override void MSC_OnLoad(MySummerCarTweaksMod mod)
        {
            ...
            betterFPSMeter.FakeMultiplier = _fpsMultiplier.GetValue();
